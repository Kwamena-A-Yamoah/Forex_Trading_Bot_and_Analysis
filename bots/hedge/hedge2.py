...
HEDGE_LOT_SIZES = [0.01, 0.03, 0.07, 0.16, 0.36, 0.82, 1.86, 4.22, 9.58, 21.75]
MAGIC_NUMBER = 10002
LOG_FILE = "trade_log.txt"
INITIAL_TP_PIPS = 12000  # Take profit for initial trade
HEDGE_DISTANCE_PIPS = 6000  # Distance in pips for hedge orders
EQUITY_TP_PIPS = 6500  # Equity take profit in pips
start_time = datetime.strptime("09:01", "%H:%M").time()
