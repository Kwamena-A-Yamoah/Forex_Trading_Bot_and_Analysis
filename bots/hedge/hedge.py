...
# HEDGE_LOT_SIZES = [0.1, 0.3, 0.7, 1.6, 3.6, 8.2, 18.6, 42.2]  # Lot size sequence
HEDGE_LOT_SIZES = [0.01, 0.03, 0.07, 0.16, 0.36, 0.82, 1.86, 4.22, 9.58, 21.75, 49.36]
MAGIC_NUMBER = 10002
LOG_FILE = "trade_log.txt"
INITIAL_TP_PIPS = 8000  # Take profit for initial trade
HEDGE_DISTANCE_PIPS = 6000  # Distance in pips for hedge orders (you can change this)
EQUITY_TP_PIPS = 6500  # Equity take profit in pips (you can change this)
...
def sleep_until_trading_hours():
    ...
    print(f"⏸ Sleeping for {hours}h {minutes}m {seconds}s until {start_time.strftime('%H:%M')}...")
